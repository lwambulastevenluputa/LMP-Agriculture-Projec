...
?>
<br />
<small style="font-size:13px; color:white; background:#ffa50a; padding:5px; border-radius:5px; text-transform:capitalize; font-family:'Roboto Slab',serif;">Not On Mango</small>
<?php
}
?>
</div>

...
<b style="font-size:12px; text-transform:capitalize"><?php if(strlen($name)<50){echo $name;}else{echo substr($name,0,50).'...';} ?></b>
</div>
<div style="height:40px">
<small style="font-size:12px; text-transform:capitalize"><?php if(strlen($desc)<100){echo $desc;}else{echo substr($desc,0,100).'...';} ?></small>
</div>
<div align="right" style="height:20px">
<b style="font-size:14px; font-weight:600; color:#f40; text-transform:capitalize"><?php if(strlen($price)<10){echo $price;}else{echo substr($price,0,10).'...';} ?></b>
</div>
</td>
</tr>
</table>
...
?>
	...
	<div align="center" style="width:100%; border-bottom:1px #ddd solid; padding-top:5px; height:38px">
				...
				<a href="store.php"><input type="submit" style="width:140px; height:30px; color:#070; background:#fff; border-radius:5px; border:1px #999 solid" value="View More In Store"/></a>
				</div>

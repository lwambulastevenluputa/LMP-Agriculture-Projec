<?php include 'controllers/user_auth.php'; ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center bg-mango-orange">
                                        <div class="small"><a href="index.php" class="text-white">Merchant Dashboard</a><a href="login.php" class="text-white d-none">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

<?php 
    ...
    if(isset($_POST['add_product'])) {
        ...
        $target_dir = "merchant/assets/uploads/";
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="add-product.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <!-- Seller Info -->
                                        <div class="form-group">
                                            <input type="text" name="pSeller" placeholder="Enter seller Name or Company" class="form-control" required>
                                        </div>
                                        ...
                                        <input type="submit" name="add_product" value="Create Product" class="btn btn-block" style="background-color: #ffcc80">

...
<body onLoad="startsound();">
    ...
    <div class="main-section">
        ...
        <div style="
		padding-top: 5px">
            <div class="column left" id="chats_drawer" style="transition:all 1s" onMouseOver="document.getElementById('mango_sync').style.display='none';
			...
			document.getElementById('mango_active').style.display='none'">
                ...
                <div class="head-section">
                    <div class="headLeft-section">
						...
						padding-bottom: calc(2% - 1px);">
                            <input class="chat-search" type="text" name="search" placeholder="Search your chats">
                        </div>
                    </div>
                </div>
                ...
                <div class="start-chat-group" style="
				width:100%;
				padding-left:7%;
				padding-top: 5px;
				padding-bottom: 5px;">

                    <button type="submit" onClick="document.getElementById('mango_left_chats').style.display='none';
                ...
                <div class="body-section" style="overflow-y: scroll; 
				overflow-x: hidden;">
                    ...
                    <div id="mango_left_chats">
                        ...
                        <div class="chatList mangochats" title="Tap to talk to <?php echo $c1; ?>"
                            onClick="refreshingconv('<?php echo $c7; ?>');document.getElementById('convref').value='<?php echo $c7; ?>';document.getElementById('convuser').value='<?php echo $c4; ?>';document.getElementById('img_contact').value='<?php echo $c4; ?>';document.getElementById('img_chatref').value='<?php echo $c7; ?>';document.getElementById('vid_contact').value='<?php echo $c4; ?>';document.getElementById('vid_chatref').value='<?php echo $c7; ?>';document.getElementById('conversation_name').innerHTML='<?php echo $c1 . ' ' . $c2; ?>';">
                            <div class="img">
                            ...
                            <div class="desc">
                                ...
                                <h5 style="font-size:13px"><?php $c10 = $c1 . ' ' . $c2;
                                        ...
                                        style="color:#f60; font-size:18px; margin-top:2px">&bull;</b></h5>
                                <small>
                                    <p>
                                        <?php
                                                    ...
                                                    if (mysqli_num_rows($result5) > 0) {
                                                        if ($row5 = mysqli_fetch_array($result5)) {
                                                            if (strlen($row5['message']) < 25) {
                                                                echo $row5['message'];
                                                            } else {
                                                                echo substr($row5['message'], 0, 20) . '...';
                                                            }
                                                        }
                                                    }
                                                    ?>.</p>
                                ...
                                <small>
                                    <p style="color:#f60; font-weight:600"><?php if ($c3 > 0) {
                                                                                            echo $c3; ?> New
                                        Notifications<?php } ?></p>
                                </small>
                            </div>
                    ...
                    <div id="mango_left_contacts" style="display:none;
				text-align:center;">

                        <input id="add_contact_input" type="submit"
                            onClick="document.getElementById('newcontact').style.display=''" title="Create New Contact"
				...
				height:35px">
					...
					margin-left:10px">
                        ...
                        <div id="newcontact" align="center" style="
				display:none; 
				overflow-y:auto; 
				position:fixed; 
				top:30%; 
				...
				border-radius:10px">
                            ...
                            <div align="right" onClick="document.getElementById('newcontact').style.display='none'"
                                style="
					width:100%; 
					font-size:30px; 
					height:10%; 
				...
				font-family:'Roboto', serif;">
                                ...
                                <form method="post" action="contacts.php">
                                    <input type="tel" name="addcontact_number" id="addcontact_number"
                                        placeholder="Phone Number" required style=" 
						text-align:center; 
						width:50%; 
						height:30px; 
						border:1px solid #E6E6E6; 
				...
				background:#fff">
                    ...
                    <div style="
						...
						left:15px;
						bottom:50px;">
                        <i class="fas fa-cog fa-2x" id="acc-settings"></i>
						...
						display:none;
                            ...
                            <div class="mangosettings" id="mangosettings-profile">
                                &nbsp;Profile
                            </div>
            ...
            <div class="column center" id="conv_drawer" style="transition:all 1s" onMouseOver="document.getElementById('mango_sync').style.display='none';
			document.getElementById('mango_cart').style.display='none';
			document.getElementById('mango_contact').style.display='none';
			document.getElementById('mango_wallet').style.display='none';
			document.getElementById('mango_mail').style.display='none';
			...
			document.getElementById('mango_active').style.display='none'">
                ...
                <div class="head-section">
                    ...
                    <div class="headCenter-section" style="
					display: flex; 
					justify-content: space-between;">
                        ...
                        <div style="
                            ...
                            <span id="conversation_name" style="
								cursor:pointer;">
                                <img src="<?php echo profimg($c4); ?>" alt="Youre talking to <?php echo $c1; ?>"
                                    class="avatar">
                                <?php
                        ...
                        <div id="chat-menu" style="
                            ...
                            <div style="
								display: flex; 
								right:0; 
								padding-top: 30px" align="right">

                                <div class="dropdown-search" style="
									padding-right:10px;">
                                    <i class="far fa-search fa-lg" style=" cursor: pointer;" id="menu-search"></i>
                                </div>
                                <input class="searchname" align="left" autocorrect="off" autocomplete="off" style="outline:none; 
									width: 200px;
									border:1px solid #bfbfbf;
									border-radius: 15px; 
									background: #fff; 
									font-size:13px;
									display: none;" name="searchname" type="text" id="myInput" onKeyUp="myFunction()"
                                    placeholder="Search in conversation..." title="Filter">&nbsp;
                                <i class="fas fa-arrow-right fa-lg" style="color: #898989;
									cursor:pointer;
									display:none;" id="menu-search-arrow"></i>
                                ...
                                <div id="mango_options" style="display:none; 
									margin-top: 55px;
									overflow-y:auto; 
									position:absolute;
									left: 45%;
                ...
                <div class="body-section">
                    ...
                    <div align="right" style="width:100%; border-bottom:1px #ddd solid; padding-top:5px; height:35px">
                        ...
                        <input class="searchname" align="left" autocorrect="off" autocomplete="off"
                            style="outline:none; border:none; background:none; color:#000; font-size:12px; float:left"
                            name="searchname" type="text" id="myInput" onKeyUp="myFunction()"
                            placeholder="Type to filter conversation" title="Filter">


                        <span
                            style="color:#000; text-transform:capitalize; font-size:12px; float:right; margin-top:5px; margin-right:10px"><a
                                href="<?php echo $_SERVER['REQUEST_URI']; ?>" id="refresh"
                                style="color:#000">Refresh.</a></b></span>
                    ...
                    <?php
                        ...
                        ?>
                    <div id="conversations" class="center-section-middle"
                        style="overflow-y: scroll; background-image:url(<?php echo $bg; ?>); background-repeat:no-repeat; background-position:center; background-size:100% 100%; width:100%; height:80%; display:inline-block; overflow-x: hidden;">


                        <div id="tapachat" align="center"
                            style="font-size:16px; margin-top:100px; color:#f60; height:40px; width:100%">
                    ...
                    <div id="mango_day_bg" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:0%; left:0%; width:100%; height:100%; background:#63a; z-index:999999999; color:#000; overflow:hidden">
                        <div style="padding:150px">
                            <b style="font-size:24px; color:#000">Send To A Mango And</b>
                            <br>
                            <b style="font-size:80px; color:#000">Make That <span id="mango_day_bg_text"
                                    style="text-transform:capitalize">Someone's</span> Day</b>
                        </div>
                    </div>
                    ...
                    <div id="mango_bg" onClick="closemangoes()" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:0%; left:0%; width:100%; height:100%; background:rgba(255,255,255,0.3); z-index:99999; color:#000; overflow:hidden">
                    </div>


                    <div id="mango_video" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:12%; left:19%; width:600px; height:600px; background:#f40; color:#000; z-index:999999999; overflow-y:auto; box-shadow:0 0 5px 5px #555; border-radius:50% 50% 50% 30%; padding-top:75px">

                        <div align="center"
                            style=" width:400px; height:400px; background:#000; color:#fff; overflow-y:auto; border-radius:50%">
                    ...
                    <div id="mango_image" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:12%; left:19%; width:600px; height:600px; background:#f40; color:#000; z-index:999999999; overflow-y:auto; box-shadow:0 0 5px 5px #555; border-radius:50% 50% 50% 30%; padding-top:75px">
                    ...
                    <div id="mango_1" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:20%; left:27%; width:400px; height:400px; background:#f40; color:#000; z-index:999999999; overflow-y:auto; box-shadow:0 0 5px 5px #555; border-radius:50% 50% 50% 30%; padding-top:45px">

                    </div>

                    <div id="mango_2" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:10%; left:35%; width:400px; height:400px; background:#f40; color:#000; z-index:999999999; overflow-y:auto; box-shadow:0 0 5px 5px #555; border-radius:50% 50% 50% 30%; padding-top:45px">
                    ...
                    <div id="mango_fruit" align="center"
                        style=" display:none; overflow-y:auto; position:fixed; top:30%; left:10%; width:30%; height:40%; background:#fff; color:#000; overflow-y:auto; box-shadow:0 0 5px 5px #555; border-radius:10px; padding:10px">

                        <div align="right" onClick="document.getElementById('mango_fruit').style.display='none'"
				...
				-->
                    ...
                    <div id="mango_webcam" align="center" style="display:none; 
				overflow-y:auto; 
				position:fixed; 
				bottom:10%; 
				left:15%; 
				...
				border-radius:10px;">
                        ...
                        <div align="left" onClick="document.getElementById('mango_webcam').style.display='none'" style="width:100%; 
					font-size:35px; 
					height:40px; 
                            ...
                            <table style="width:80%;">
                                <tr style="vertical-align:middle">
                                    <td style="width:25%" align="center">
                                        <button onClick="startcam()" id="start-cam-button">
                                            <i class="fas fa-play fa-lg"></i>
                                        </button>
                                    </td>
                                    <td style="width:25%" align="center">
                                        <button onClick="stop()" id="stop-cam-button">
                    ...
                    <div id="mango_send_image" align="center" style="display:none; 
				overflow-x:hidden;
				overflow-y:auto; 
				...
				padding:10px">
                        ...
                        <div align="left" onClick="document.getElementById('mango_send_image').style.display='none'"
                            style="
						width:100%; 
						font-size:35px; 
						height:40px; 
					...
					width:30%">
                            ...
                            <br>
                            <div align="center">
                                <input name="piccaption" type="text" style="
						border:1px solid #E6E6E6; 
						border-radius:10px; 
						outline:none; 
						background:#fff; 
						...
						text-align:center; 
						height:30px; 
						width:100%" maxlength="1000" placeholder="caption...">
                                />
                            </div>
                    ...
                    <div id="mango_send_video" align="center" style="display:none; 
				overflow-x:hidden;
				overflow-y:auto; 
				position:fixed; top:25%; 
				left:20%; 
				...
				padding:10px">
                        ...
                        <div align="left" onClick="document.getElementById('mango_send_video').style.display='none'"
                            style="width:100%; 
						font-size:35px; 
						height:40px; 
						color:#000; 
                    ...
                    <div id="mango_code" align="center" style="display:none; 
				overflow-y:auto; 
				position:fixed; 
				top:30%; 
				left:10%; 
				...
				padding:10px">
                        ...
                        <div align="right" onClick="document.getElementById('mango_code').style.display='none'"
                            style="width:100%; font-size:24px; height:40px; border-bottom:1px #ddd solid; color:#000; padding-top:5px">
                            &times; &nbsp;&nbsp;
                        </div>
                    ...
                    function enteremoji(a) {
                        ...
                        if (a == 'long_laugh') {
                            b.innerHTML = b.innerHTML +
                                "<img src='emoticons/long_laugh.png' style='width:14px; height:14px'/>";
                        }

                        document.getElementById('convusermsg').value = document.getElementById('convusermsg_div')
                            .innerHTML;
                    ...
                    <div class="center-section-bottom"
                        style="display:inline-block; border-top:none; background:#fff; height:200px; width:100%"
                        align="center">
                        <table style="width:100%; height:50px">
                            <tr style="vertical-align:middle" align="center">
                                <td style="width:5%">
                                    <span onClick="document.getElementById('mango_smileys').style.display=''"><img
                                            src="emoticons/long_laugh.png" style="height:40px; width:40px"></span>



                                    <div id="mango_smileys" align="center" style="display:none; 
				overflow-y:auto; 
				position:absolute; 
				bottom:5%; 
				width:200px; 
				...
				color:#000; ">
                                ...
                                <td style=" width:70%; padding-top:0px">
                                    ...
                                    <div contentEditable="true" id="convusermsg_div"
                                        style=" outline:none; border:2px #555 solid; font-size:13px; height:30px; max-width:100%; overflow-x:auto; white-space:normal; width:100%; padding-top:3px; border-radius: 15px; overflow-y:auto">
                                        type your message here...</div>
                                </td>
                                <td style="width:5%; padding-top:8px">

                                    <i onClick="if(document.getElementById('convref').value){sendsubmit();refreshingconv2(document.getElementById('convref').value);}"
            ...
            <div class="column right" id="store_drawer" style="transition:all 1s"
                ...
                <div align="right" onClick="showmangostore()" style="color:#000; 
				border-bottom:1px #ddd solid; 
				font-size:24px">
                    <span id="mangostoretext" style="color:#000; 
				font-size:12px; 
				float:left; 
				margin-top:10px; 
				margin-left:10px">
			...
			display: none;">
                    ...
                    <div style="float: right;">
                        <i class="fas fa-times fa-lg" id="close-profile"></i>
                    </div>
				...
				vertical-align:middle;">
                            <form method="post" action="profile.php" enctype="multipart/form-data">
                                <input type="file" name="prfileToUpload1" id="prfileToUpload1" accept="image/*"
                                    style="display:none"
                                    onChange="document.getElementById('upltext1').innerHTML='Selected'">

                                <td style="
				width:50%;
				text-align: center;">
                                    <div id="change-prof-pic-div">
                                        <label id="change-prof-pic" for="fileToUpload1">
                                            Upload
                                        </label>
                                    </div>
                                </td>
				...
				width:50%;
				text-align:center;">
                                    <button style="float: left;" type="submit" id="save-photo">
                                        Save
                                    </button>
                                </td>
                            </form>
				...
				text-align:center;">
                        <a href="#">
                            <button type="submit" title="Change Visibility" id="visibility-button">
                                Active
                            </button>
                        </a>
                    </div>
							...
							text-align:center;">
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"
                                    ...
                                    <input type="file" name="fileToUpload" id="fileToUpload"
                                        ...
                                        accept="image/*" style="display:none" onChange="cam(this)">

                                    <div id="change-prof-pic-div">
                                        <label id="change-prof-pic" for="fileToUpload">
                                            Choose
                                        </label>
                                    </div>
                            </td>
					...
					padding:0 2%;">
                        ...
                        <b style="float:right;
						  padding-right:25%;">
                            Last Name</b>
                        <br>
                        <input type="text" placeholder="first name" value="<?php echo $a; ?>" style="height:30px; 
						text-align:center; 
						width:48%;
						border: 1px solid #bfbfbf;
						border-radius:5px;
						font-size:15px;
						font-family:'Roboto',serif;
						outline:none;" name="prfirst_name">
                        <?php
                            $query5 = "SELECT * FROM mango_user_credentials WHERE mobile_number='" . number . "' ORDER BY id DESC LIMIT 1";
                            //Execute the query
                            $result5 = mysqli_query($connect, $query5);
                            ...
                            ?>
                        <input type="text" placeholder="last name" value="<?php echo $a; ?>" style="
						height:30px; 
						text-align:center; 
						width:48%;
						float:right;
                        ...
                        <b style="float:right;
						  padding-right:18%;">
                            Mobile Number</b>
                        <br>
                        <input type="number" placeholder="ID number" value="<?php echo $a; ?>" style="
						height:30px; 
						text-align:center; 
						width:48%;
						border: 1px solid #bfbfbf;
                        ...
                        <?php
                            ...
                            ?>
                        <input type="hidden" placeholder="mobile number" value="<?php echo $a; ?>" style="
						height:30px; 
						text-align:center; 
						width:48%;
						float:right;
						...
						font-size:15px;
						font-family:'Roboto',serif;
						outline:none;" name="prmobile_number">

                        <input type="tel" placeholder="mobile number" value="<?php echo $a; ?>" style="
						height:30px; 
						text-align:center; 
						width:48%;
						float:right;
                        ...
                        <input type="date" placeholder="date of birth" value="<?php echo $a; ?>" style="
						height:30px; 
						text-align:center; 
						width:48%;
						border: 1px solid #bfbfbf;
                        ...
                        <?php
                            ...
                            ?>
                        <input type="email" placeholder="email" value="<?php echo $a; ?>" style="
				height:30px; 
				text-align:center; 
				width:48%;
				float:right;
				...
				outline:none;" name="premail">
					...
					font-family:'Roboto',serif;
					outline:none;">
                            <option value="male" <?php if ($a == 'male' || $a = '') { ?>selected="selected" <?php } ?>>
                                Male
                            </option>
                            <option value="female" <?php if ($a == 'female') { ?>selected="selected" <?php } ?>>
                                Female
                            </option>
                        </select>
                        <br>
                        ...
                        <b>Address</b>
                        <br>
                        <input type="text" placeholder="Street" value="<?php echo $a; ?>" style="
					height:30px; 
					text-align:center; 
					width:48%;
					border: 1px solid #bfbfbf;
					...
					outline:none;" name="prstreet">
                        <?php
                            ...
                            ?>
                        <input type="text" placeholder="City" value="<?php echo $a; ?>" style="
					height:30px; 
					text-align:center; 
					width:48%;
					border: 1px solid #bfbfbf;
					...
					float:right;" name="prcity">
                        ...
                        <?php
                            ...
                            ?>
                        <input type="text" placeholder="Province" value="<?php echo $a; ?>" style="
					height:30px; 
					text-align:center; 
					width:48%;
					border: 1px solid #bfbfbf;
					...
					outline:none;
					float:right;">
                            <option value="zambia" <?php if ($a == 'zambia' || $a = '') { ?>selected="selected"
                                <?php } ?>>
                                Zambia
                            </option>
                        </select>
                        ...
                        <?php
                            ...
                            ?>
                        <input type="number" placeholder="zip-code" value="<?php echo $a; ?>" style="
				height:30px; 
				text-align:center; 
				width:48%;
				border: 1px solid #bfbfbf;
				...
				font-size:15px;
				font-family:'Roboto',serif;
				outline:none;" name="przip_code">
                        <br>
                        <br>

                        <input id="profile-save-button" type="submit" value="Save Changes">
        ...
        <div id="wallet"
            style="height:500px; display:none; overflow-y:auto; overflow-x:hidden; width:100%; color:#000; font-size:14px; background:#fff">

            <table style="width:100%; height:30px">
                <tr style="vertical-align:middle" align="center">
                    <td class="mangoaddonstop" title="Inbox"
                        onClick="document.getElementById('shop').style.display='';document.getElementById('wallet').style.display='none';"
                        style="width:50%">
                        <a style="color:inherit">
                            Inbox
                        </a>
                    </td>
                    <td class="mangoaddonstop" title="Sent Box"
                        onClick="document.getElementById('shop').style.display='none';document.getElementById('wallet').style.display='';"
                        style="width:50%">
                        <a style="color:inherit">
                            Sent Box
                        </a>

                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username" class="form-control py-3 input-lg" value="<?php echo $username ?>" id="username" aria-describedby="emailHelp" placeholder="Mobile Number or Email Address"> 
                                            ...
                                            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                                ...
                                                <input type="password" class="form-control py-3 input-lg" name="password"  id="password" placeholder="Password" />
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <!-- Singin Btn -->
                                                <input type="submit" name="signin" value="Login" class="btn pull-right" style="background-color: #ffcc80">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center bg-mango-orange">
                                        <div class="small"><a href="signup.php" class="text-white">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

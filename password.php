                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header bg-mango-orange"><h3 class="text-center font-weight-light my-4 text-white">Password Recovery</h3></div>
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small text-mango-orange" href="login.php">Return to login</a>
                                                <a class="btn" href="login.php" style="background-color: #ffcc80">Reset Password</a>
                                            </div>
                                        </form>
                                    </div>

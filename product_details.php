<?php
    ...
    if(isset($_GET['id'])) {
        ...
        $query2 = "SELECT * FROM mango_user_credentials WHERE mobilenumber='$uphone' LIMIT 1 DESC";
    ...
    <div class="container top-padding-60">
        ...
        <div class="row mt-4 pb-3">
           ...
           function open_chat(n,e,b){
                ...
                document.getElementById('conversation_name').innerHTML=n;document.getElementById('drawer1').style.display='none';document.getElementById('drawer2').style.display='none';document.getElementById('drawer3').style.display='none';refreshingconv(b);document.getElementById('convref').value=e;document.getElementById('convuser').value=b;document.getElementById('img_contact').value='img';document.getElementById('img_chatref').value=b;document.getElementById('vid_contact').value=e;document.getElementById('vid_chatref').value=b;document.getElementById('drawerbg').style.display='';document.getElementById('mangostore_conv').style.display='';
...
$.ajax({
			...
			url:'contacts_productdetails_chat.php',
...
add_chat(n,e,b);
    ...
    $dbname = "u863218974_mango";
                ...
                <div onclick="save_to_contacts('<?php echo $uphone; ?>','<?php echo $full; ?>','<?php echo $uphone; ?>');" style="color:#070; cursor:pointer">

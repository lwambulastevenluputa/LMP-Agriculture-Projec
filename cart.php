    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div style="display:<?php if (isset($_SESSION['showAlert'])) {
                                ...
                                unset($_SESSION['showAlert']); ?>" class="alert alert-success alert-dismissible mt-4">
                ...
                <table class="table table-hover text-center">
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="" class="badge-danger badge p-1"
                                    onclick="return confirm('Are you sure you want to clear you cart')">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- delete cart coloumn -->
                            <td><a href="addToCart.php?remove=<?= $row['id'] ?>" class="text-danger lead"
                                    onclick="return confirm('Are you sure you want to delete this product you cart')">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="checkout.php"
                                    class="btn bg-mango-orange <?= ($grand_total > 1) ? "" : "disabled" ?>">
...
$(document).ready(function() {
    ...
    $(".itemQty").on('change', function() {
        var $el = $(this).closest(
            'tr'); // this is becz all the hidden input we want to access are in the tr element

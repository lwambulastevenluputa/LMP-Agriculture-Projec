...
<div id="mangostore_conv"
    ...
    <div id="chat_conv_space" style="width:100%">
        ...
        <div align="center"
            style="height:10vh; width:100%; overflow-x:hidden; white-space:nowrap; border:none; <?php
                                                                                                                if ($theme == 'dark') {
                                                                                                                    echo 'background:#222; color:#fff';
                                                                                                                } else {
                                                                                                                    echo 'background:#fff; color:#000';
        ...
        <input id="myInput" onKeyUp="myFunction()" align="center"
            style="height:5vh; color:#f60; outline:none; padding-top:5px; font-size:15px; width:100%; text-decoration:none; border:none;<?php
                                                                                                                                                                                                if ($theme == 'dark') {
                                                                                                                                                                                                    echo 'background:#222';
                                                                                                                                                                                                } else {
                                                                                                                                                                                                    echo 'background:#fff';
            ...
            <tr style="vertical-align:middle">
                ...
                <td style="width:70%" align="left">
                    ...
                    <span style="font-size:14px; font-weight:600"><?php $c10 = $c1 . ' ' . $c2;
                            ...
                            style="color:#f60; font-size:18px; margin-top:2px">&bull;</b></span>
                    <br>

...
<div>
    <div id="convlog" class="message">
        <ul id="myUL" style="margin-bottom:70px; 
							padding-bottom:70px">
            ...
            <li>
                <a>
                    <div align="right" class="talkbubble4" id="thread<?php echo $inc; ?>">
                        ...
                        <div <?php if ($type2 == 'image') { ?> style="min-height:200px" <?php } ?>>

                            <?php if ($type2 == 'image') {
                                                        ?>
                            <div align="left" style="width:100%; padding:10px">
                                <img id="conv_hover" onclick="showinfull('conv_hover')"
                                    src="uploads/<?php echo $type; ?>" alt="image" controls type="image/png" style="
    height:100px;
    width:200px;
margin-right:10px; 
width:100px;
border-radius:1px" />
                            ...
                            <video controls style="
										...
										border-radius:1px">
                                <source src="uploads/<?php echo $type; ?>" type="video/mp4" />
                            </video>
                            <br />
                            <?php
                                                        }
                        ...
                        <small style="margin-top:5px; color:#fb0">
                            <?php
                                                        if ($type !== 'reply') {
                                                        ?>
                            <span onClick="document.getElementById('reply<?php echo $a . $refid; ?>').style.display=''"
                                style="cursor:pointer">Reply</span>
                            <table id="reply<?php echo $a . $refid; ?>"
                                style="position:absolute; display:none; z-index:99999999; height:34px; width:240px; border-radius:10px; background:#fff; color:#000; margin-right:300px; box-shadow:0 0 2px 2px #999">
                                <tr align="center" style="vertical-align:middle">
                                    ...
                                    <td style="width:10%">
                                        <i onclick="document.getElementById('replyform<?php echo $a . $refid; ?>').submit()"
                                            class="fa fa-send" style="height:30px; margin-top:19px; width:30px"></i>
                                        </form>
                                    </td>
                                    <td style="width:10%; font-size:17px; color:#f00"
                                        onClick="document.getElementById('reply<?php echo $a . $refid; ?>').style.display='none'">
                                        &times;</td>
                                </tr>
                            </table>
                            <?php
                                                        ...
                                                        ?>
                            <span onClick="document.getElementById('thread<?php echo $inc; ?>').style.display=''"
                                style="cursor:pointer">Save</span>
                            <span
                                onClick="document.getElementById('thread<?php echo $inc; ?>').style.transform='rotate(180deg)'"
                                style="cursor:pointer">Rotate</span>
                        </small>
                    ...
                    <div align="left" class="talkbubble2" id="thread<?php echo $inc; ?>">
                        ...
                        <div id="talkbubble2" style="width:100%; margin-bottom:5px">
                            <span style="margin-top:5px; color:#777; font-size:12px">
                                Replying to this message on <?php echo $row5['date']; ?> at
                                <?php echo $row5['time']; ?></span>
                            <br>
                            <?php echo $row5['message']; ?>
                        </div>
                        <?php
                        ...
                        <div <?php if ($type2 == 'image') { ?> style="min-height:200px" <?php } ?>>
                            <?php if ($type2 == 'image') {
                                                        ?>
                            <div align="left" style="width:100%; padding:10px">
                                <img id="conv_hover2" onclick="showinfull('conv_hover2')"
                                    src="uploads/<?php echo $type; ?>" alt="image" controls type="image/png" style="
    height:100px;
    width:200px;
margin-right:10px; 
...
border-radius:1px" />
                        ...
                        <small style="margin-top:5px; color:#fb0">
                            ...
                            <span onClick="document.getElementById('reply<?php echo $a . $refid; ?>').style.display=''"
                                style="cursor:pointer">Reply</span>
                            <table id="reply<?php echo $a . $refid; ?>"
                                style="position:absolute; display:none; z-index:99999999; height:34px; width:250px; border-radius:10px; background:#fff; color:#000; left:70px; margin-right:10px; box-shadow:0 0 2px 2px #999">
                                <tr align="center" style="vertical-align:middle">
                                    <td style="width:80%">
                                        <form id="replyform<?php echo $a . $refid; ?>" method="post" action="reply.php">
                                            <input type="hidden" name="replyref" value="<?php echo $a; ?>" />

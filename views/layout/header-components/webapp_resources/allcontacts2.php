...
-->
                        ...
                        <a href="index.php?c=<?php echo $mob_ref; ?>">
                            <?php
                                    ...
                                    ?>
                            <div
                                style="min-height:90px; background:none; border-radius:5px; min-width:90px; color:#fff">
                                <img src="img/Mango.jpg"
                                    style="width:60px; background:none; height:60px; margin-bottom:5px; margin-top:5px; border-radius:50%; <?php if ($active == 1) {
                                                                                                                                                                            echo 'border:5px #f60 solid';
                                                                                                                                                                        } else {
                                                                                                                                                                            echo 'border:5px #555 solid';
                                                                                                                                                                        }
                                                                                                                                                                        ?> " />
                                <br>
                                <?php
                                ...
                                <br />
                                <small
                                    style="font-size:12px; color:#000; background:#f60; color:#fff; padding:5px; border-radius:5px; text-transform:capitalize">Not
                                    On Mango</small>
                                <?php
                                        }
                                        ?>

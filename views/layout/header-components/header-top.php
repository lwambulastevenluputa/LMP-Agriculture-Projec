            ...
            <div class="col-sm-6">
                <div class="social-icons pull-right">
                    <ul class="unstyled d-flex">
                        ...
                        <li><a href="#"
                                class="link <?php if (!isset($_SESSION["loggedin"])) echo "d-none" ?>">Watchlist</a>
                        </li>
                        <li><a href="logout.php"
                                class="link <?php if (!isset($_SESSION["loggedin"])) echo "d-none" ?>">Sign Out</a></li>
                        <li><a href="signin.php"
                                class="link <?php if (isset($_SESSION["loggedin"])) echo "d-none" ?>">Sign in</a></li>
                        <li><a href="signup.php"
                                class="link <?php if (isset($_SESSION["loggedin"])) echo "d-none" ?>">Sign up</a></li>
                        <li><a href="#"><i
                        ...
                        <li class="cart-icon"><a href="cart.php"><i class="fas fa-shopping-cart "></i><span
                                    id="cart-item" class="badge"

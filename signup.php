                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group <?php echo (!empty($firstname_err)) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="text" name="firstname" class="form-control input-lg" value="<?php echo $firstname; ?>" id="firstname" aria-describedby="firstNameHelp" placeholder="First name">
                                                        <span class="help-block"><?php echo $firstname_err; ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 <?php echo (!empty($lastname_err)) ? 'has-error' : ''; ?>">
                                                    <!-- Last Name -->
                                                    <div class="form-group">
                                                        <!-- <label class="small mb-1" for="inputLastName">Last Name</label> -->
                                                        <!-- <input class="form-control py-4" id="inputLastName" type="text" name="lname" placeholder="Enter last name" /> -->
                                                        <input type="text" name="lastname" class="form-control input-lg" value="<?php echo $lastname; ?>" id="lastname" aria-describedby="lastNameHelp" placeholder="Last name">
                                            ...
                                            <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                                                ...
                                                <input type="email" name="email" class="form-control input-lg" value="<?php echo $email; ?>" id="email" aria-describedby="emailHelp" placeholder="Email">
                                            ...
                                            <div class="form-group <?php echo (!empty($mobilenumber_err)) ? 'has-error' : ''; ?>">
                                                ...
                                                <input type="tel" name="mobilenumber" class="form-control input-lg" id="mobilenumber" value="<?php echo $mobilenumber; ?>" aria-describedby="mobilenumberHelp" placeholder="Mobile Number">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="password" name="password" class="form-control input-lg" value="<?php echo $password; ?>" id="password" placeholder="Password">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="password" name="confirm_password" class="form-control input-lg" value="<?php echo $confirm_password; ?>" id="cpassword" placeholder="Confirm Password">
                                                        <span class="help-block"><?php echo '<p class="text-danger">' .$confirm_password_err. '</p>'; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="submit" name="signup" class="btn btn-lg btn-block mb-4" style="background-color: #ffcc80;" value="Sign Up">
                                    ...
                                    <div class="card-footer text-center bg-mango-orange">
                                        <div class="small"><a href="signin.php" class="text-white">Already have an account? Sign in!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

                    ...
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header bg-mango-orange">
                                <h3 class="text-center font-weight-light my-4 text-white">Create New Product</h3>
                            </div>
                            <div class="card-body">
                                <form action="add_product.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <!-- Product Code -->
                                    <div class="form-group">
                                        <input type="text" name="pCode" placeholder="Product Code" class="form-control"
                                            required>
                                    </div>

                                    <!-- Stock -->
                                    <div class="form-group">
                                        <input type="number" name="pStock" placeholder="Enter Stock Quantity"
                                            class="form-control" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-file">
                                            <input type="file" name="pImage" class="custom-file-input" id="customFile"
                                                required>
                                            <label for="customFile" class="custom-file-label">Choose Product
                                                Image</label>
                                        </div>
                                    </div />
                                    <!-- Farmer/Producer Info -->
                                    <div class="form-group">
                                        <input type="text" name="pSeller" placeholder="Farmer's Name"
                                            class="form-control" required>
                                    </div>

                                    <!-- Product Description -->
                                    <div class="form-group">
                                        <textarea name="pDescription" id="" cols="30" rows="5" class="form-control"
                                            placeholder="Enter Produt Description""></textarea>
                                            <!-- <input type=" textarea" name="product_desc" row="10" cols="20"
